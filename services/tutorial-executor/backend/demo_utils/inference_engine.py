...
# demo_utils/interface_engine.py
import logging
import os
import time
...
class OpenaiEngine(Engine):
    def __init__(
            self,
            api_key="sk-NwR2ef8kRfO7kOcoE79997Ff32784c3c9476E635689f51Ad",
    ...
    @backoff.on_exception(
        backoff.expo,
        (APIError, RateLimitError, APIConnectionError, OpenAIError, BadRequestError),
    )
    ...
    logger.info("Retrying API call due to exception...")
...
class OpenaiEngine_MindAct(Engine):
    ...
    @backoff.on_exception(
        backoff.expo,
        (APIError, RateLimitError, APIConnectionError, OpenAIError),
    )
