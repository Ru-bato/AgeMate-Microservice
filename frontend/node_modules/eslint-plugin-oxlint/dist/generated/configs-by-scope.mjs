import { eslintRules, typescriptRules, importRules, jestRules, jsdocRules, jsxA11yRules, nextjsRules, nodeRules, promiseRules, reactRules, reactHooksRules, reactPerfRules, treeShakingRules, unicornRules, vitestRules } from "./rules-by-scope.mjs";
const eslintConfig = {
  name: "oxlint/eslint",
  rules: eslintRules
};
